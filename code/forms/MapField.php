...
class MapField extends FormField
{
     ...
     */
    public function setMapObjectClass($className)
    {
        $this->mapObjectClass = $className;
    }

    public function getMapObjectClass()
    {
     ...
     * @param string
     */
    public function setAddressPlaceholder($text)
    {
        $this->addressFieldPlaceholder = $text;
    }

    public function getAddressPlaceholder($text)
    {
    ...
    public function setMapWidth($min, $max = null)
    {
        if ($max) {
    ...
    public function setMapHeight($min, $max = null)
    {
        if ($max) {
    ...
    public function setStoreAddress($bool)
    {
