...
class GoogleMap extends DataObject
{
     ...
     * @var boolean
     */
    public static $include_frontend_script = true;
     ...
     * @var boolean
     */
    public static $include_api_script = true;
     ...
     */
    public function getStaticMapLink($width = null, $height = null)
    {
     ...
     */
    public static function frontend_script_src()
    {
     ...
     */
    public static function api_script_src()
    {
